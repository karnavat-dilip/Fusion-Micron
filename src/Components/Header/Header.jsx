    ...
    return (
        <>
                ...
                <div className='header-tops'>
                    <div className='container'>
                        <div className='container-child'>
                            <div>
                                <h4>Welcome to our Fusion Micron</h4>
                            </div>
                            <div>
                                <ul className='header-user-menu'>
                                    <li>
                                        <IoIosCall /><Link to='tel:+91 9427392493'>+91 9427392493</Link>
                                        {/* <Link to='tel:+91 9898487120'>+91 9898487120</Link> */}
                                    </li>
                                    <li>
                                        <IoMdMail />
                                        <Link to='mailto:fusionmicron@gmail.com'>fusionmicron@gmail.com</Link>
                                    </li>
            ...
            <div className='Whatsapp'>
                <ul>
                    <li>
                        <Link to='https://api.whatsapp.com/send/?phone=919427392493&text&type=phone_number&app_absent=0' target='_blank'><FaSquareWhatsapp style={{
                            width: '47px',
                            height: '48px',
                            color: '#25d366'
                        }} />
                                ...
                                >
                                    <div className="offcanvas-mobile-menu-wrapper">
                                        ...
                                        <div className="mobile-menu-top">
                                            <span>
                                                <b>Welcome to our Fusion Micron</b>
                                            </span>
