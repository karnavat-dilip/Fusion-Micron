...
function About() {
    return (
        <div>
            <p>"Fusion Micron" produces Ground Calcium Carbonates (CaCO3) with series of different brightness and particle sizes as per the requirement of the industry and the customers.
                ...
                <div className='container'>
                    <div className='about-container'>
                        ...
                        <div className='second-child' data-aos="fade-up">
                            <h1>Welcome To Fusion Micron</h1>
